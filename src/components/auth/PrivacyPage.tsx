  ...
  return (
    <div className="w-full min-h-screen bg-black text-white overflow-y-auto font-sans relative">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24 font-sans text-white/70 leading-[1.7]">
        ...
        <h2 className="text-xl md:text-2xl font-medium text-white mb-6 mt-12">1. Introduction</h2>
        <p className="mb-6">
        ...
        <h2 className="text-xl md:text-2xl font-medium text-white mb-6 mt-12">2. Information We Collect</h2>
        <p className="mb-6">
        ...
        <h2 className="text-xl md:text-2xl font-medium text-white mb-6 mt-12">3. Use of Your Information</h2>
        <p className="mb-6">
        ...
        <h2 className="text-xl md:text-2xl font-medium text-white mb-6 mt-12">4. Disclosure of Your Information</h2>
        <p className="mb-6">
        ...
        <p className="mb-6">
          If you have questions about this Privacy Policy, contact us at <a href="mailto:emartinezra2121@gmail.com" className="text-white border-b border-white/30 hover:border-white transition-colors">emartinezra2121@gmail.com</a>.
        </p>
      </div>
